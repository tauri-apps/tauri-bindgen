...
export async function listU8Param(x: Uint8Array): Promise<[]> {
	const result = await invoke<[]>("plugin:3d9d99368dfa9a39|list-u8-param", {
		x: x,
	});
	return result;
}
export async function listU16Param(x: Uint16Array): Promise<[]> {
	const result = await invoke<[]>("plugin:3d9d99368dfa9a39|list-u16-param", {
		x: x,
	});
	return result;
}
export async function listU32Param(x: Uint32Array): Promise<[]> {
	const result = await invoke<[]>("plugin:3d9d99368dfa9a39|list-u32-param", {
		x: x,
	});
	return result;
}
export async function listU64Param(x: BigUint64Array): Promise<[]> {
	const result = await invoke<[]>("plugin:3d9d99368dfa9a39|list-u64-param", {
		x: x,
	});
	return result;
}
export async function listS8Param(x: Int8Array): Promise<[]> {
	const result = await invoke<[]>("plugin:3d9d99368dfa9a39|list-s8-param", {
		x: x,
	});
	return result;
}
export async function listS16Param(x: Int16Array): Promise<[]> {
	const result = await invoke<[]>("plugin:3d9d99368dfa9a39|list-s16-param", {
		x: x,
	});
	return result;
}
export async function listS32Param(x: Int32Array): Promise<[]> {
	const result = await invoke<[]>("plugin:3d9d99368dfa9a39|list-s32-param", {
		x: x,
	});
	return result;
}
export async function listS64Param(x: BigInt64Array): Promise<[]> {
	const result = await invoke<[]>("plugin:3d9d99368dfa9a39|list-s64-param", {
		x: x,
	});
	return result;
}
export async function listFloat32Param(x: Float32Array): Promise<[]> {
	const result = await invoke<[]>(
		"plugin:3d9d99368dfa9a39|list-float32-param",
		{ x: x },
	);
	return result;
}
export async function listFloat64Param(x: Float64Array): Promise<[]> {
	const result = await invoke<[]>(
		"plugin:3d9d99368dfa9a39|list-float64-param",
		{ x: x },
	);
	return result;
}
...
export async function tupleList(
	...
	const result = await invoke<[bigint, number][]>(
		"plugin:3d9d99368dfa9a39|tuple-list",
		{ x: x },
	);
	return result;
}
export async function stringListArg(a: string[]): Promise<[]> {
	const result = await invoke<[]>("plugin:3d9d99368dfa9a39|string-list-arg", {
		a: a,
	});
	return result;
}
export async function stringListRet(): Promise<string[]> {
	const result = await invoke<string[]>(
		"plugin:3d9d99368dfa9a39|string-list-ret",
	);
	return result;
}
export async function tupleStringList(
	...
	const result = await invoke<[string, number][]>(
		"plugin:3d9d99368dfa9a39|tuple-string-list",
		{ x: x },
	);
	return result;
}
export async function stringList(x: string[]): Promise<string[]> {
	const result = await invoke<string[]>("plugin:3d9d99368dfa9a39|string-list", {
		x: x,
	});
	return result;
}
export async function recordList(x: SomeRecord[]): Promise<OtherRecord[]> {
	const result = await invoke<OtherRecord[]>(
		"plugin:3d9d99368dfa9a39|record-list",
		{ x: x },
	);
	return result;
}
export async function recordListReverse(
	...
	const result = await invoke<SomeRecord[]>(
		"plugin:3d9d99368dfa9a39|record-list-reverse",
		{ x: x },
	);
	return result;
}
export async function variantList(x: SomeVariant[]): Promise<OtherVariant[]> {
	const result = await invoke<OtherVariant[]>(
		"plugin:3d9d99368dfa9a39|variant-list",
		{ x: x },
	);
	return result;
}
export async function loadStoreEverything(
	...
	const result = await invoke<LoadStoreAllSizes>(
		"plugin:3d9d99368dfa9a39|load-store-everything",
		{ a: a },
	);
	return result;
}
