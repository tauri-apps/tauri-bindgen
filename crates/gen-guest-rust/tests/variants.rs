...
pub mod variants{
  ...
  pub async fn e1_arg(x: E1,) -> () {
    ...
    let params = Params {x,};
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|e1-arg", &params).await.unwrap()
  }
  ...
  pub async fn u1_arg(x: U1,) -> () {
    ...
    let params = Params {x,};
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|u1-arg", &params).await.unwrap()
  }
  ...
  pub async fn v1_arg(x: V1Param<'_,>,) -> () {
    ...
    let params = Params {x,};
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|v1-arg", &params).await.unwrap()
  }
  ...
  pub async fn bool_arg(x: bool,) -> () {
    ...
    let params = Params {x,};
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|bool-arg", &params).await.unwrap()
  }
  ...
  pub async fn option_arg(a: Option<bool>,b: Option<()>,c: Option<u32>,d: Option<E1>,e: Option<f32>,f: Option<U1>,g: Option<Option<bool>>,) -> () {
    ...
    let params = Params {a,b,c,d,e,f,g,};
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|option-arg", &params).await.unwrap()
  }
  pub async fn option_result() -> (Option<bool>,Option<()>,Option<u32>,Option<E1>,Option<f32>,Option<U1>,Option<Option<bool>>,) {
  ...
  pub async fn result_arg(a: Result<(),()>,b: Result<(),E1>,c: Result<E1,()>,d: Result<(),()>,e: Result<u32,V1Param<'_,>>,f: Result<&str,&[u8]>,) -> () {
    ...
    let params = Params {a,b,c,d,e,f,};
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|result-arg", &params).await.unwrap()
  }
  pub async fn result_result() -> (Result<(),()>,Result<(),E1>,Result<E1,()>,Result<(),()>,Result<u32,V1Result>,Result<String,Vec<u8>>,) {
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|result-result", ()).await.unwrap()
  }
  pub async fn return_result_sugar() -> Result<i32,MyErrno> {
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|return-result-sugar", ()).await.unwrap()
  }
  pub async fn return_result_sugar2() -> Result<(),MyErrno> {
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|return-result-sugar2", ()).await.unwrap()
  }
  pub async fn return_result_sugar3() -> Result<MyErrno,MyErrno> {
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|return-result-sugar3", ()).await.unwrap()
  }
  pub async fn return_result_sugar4() -> Result<(i32,u32,),MyErrno> {
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|return-result-sugar4", ()).await.unwrap()
  }
  pub async fn return_option_sugar() -> Option<i32> {
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|return-option-sugar", ()).await.unwrap()
  }
  pub async fn return_option_sugar2() -> Option<MyErrno> {
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|return-option-sugar2", ()).await.unwrap()
  }
  ...
  pub async fn is_clone_arg(a: IsCloneParam<'_,>,) -> () {
    ...
    let params = Params {a,};
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|is-clone-arg", &params).await.unwrap()
  }
  pub async fn is_clone_return() -> IsCloneResult {
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|is-clone-return", ()).await.unwrap()
  }
  pub async fn return_named_option() -> Option<u8> {
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|return-named-option", ()).await.unwrap()
  }
  pub async fn return_named_result() -> Result<u8,MyErrno> {
    ::tauri_bindgen_guest_rust::invoke("plugin:8178d1f91285bbc1|return-named-result", ()).await.unwrap()
  }
