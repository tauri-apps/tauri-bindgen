...
fn flags() {
    ...
    let (filename, contents) = gen_world(gen, "flegs", include_str!("../../../tests/codegen/flags.wit"));
...
fn lists() {
    ...
    let (filename, contents) = gen_world(gen, "lists", include_str!("../../../tests/codegen/lists.wit"));
