      ...
      match invoke.message.command() {
        "take-char" => {
          ...
          let x= match ::tauri_bindgen_host::tauri::command::CommandArg::from_command(::tauri_bindgen_host::tauri::command::CommandItem {
            ...
            Ok(arg) => arg,
            Err(err) => {
              ::tauri_bindgen_host::tracing::error!(module = "chars", function = "take-char", "Invoke handler returned error {:?}", err);
        ...
        func_name => {
          ::tauri_bindgen_host::tracing::error!(module = "chars", function = func_name, "Not Found");
