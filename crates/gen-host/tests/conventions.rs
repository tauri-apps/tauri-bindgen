      ...
      match invoke.message.command() {
        ...
        "foo" => {
          ...
          let x= match ::tauri_bindgen_host::tauri::command::CommandArg::from_command(::tauri_bindgen_host::tauri::command::CommandItem {
            ...
            Ok(arg) => arg,
            Err(err) => {
              ::tauri_bindgen_host::tracing::error!(module = "conventions", function = "foo", "Invoke handler returned error {:?}", err);
        ...
        func_name => {
          ::tauri_bindgen_host::tracing::error!(module = "conventions", function = func_name, "Not Found");
