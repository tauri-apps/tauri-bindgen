        ...
        R: ::tauri_bindgen_host::tauri::Runtime + 'static,
    {
        move |invoke| match invoke.message.command() {
            "a" => {
                ...
                module = "imports", function = "a", payload = ?invoke.message.payload()
                );
            ...
            "b" => {
                ...
                ::tauri_bindgen_host::tracing::Level::TRACE,
                "tauri-bindgen invoke handler",
                module = "imports", function = "b", payload = ?invoke.message.payload()
                );
                let _enter = span.enter();
            ...
            "c" => {
                ...
                ::tauri_bindgen_host::tracing::Level::TRACE,
                "tauri-bindgen invoke handler",
                module = "imports", function = "c", payload = ?invoke.message.payload()
                );
                let _enter = span.enter();
