...
export async function optionArg(a, b, c, d, e, f, g) {
  const result = await invoke("plugin:8178d1f91285bbc1|option_arg",{a: a, b: b, c: c, d: d, e: e, f: f, g: g});
  return result
}
/**
...
export async function casts(a, b, c, d, e, f) {
  const result = await invoke("plugin:8178d1f91285bbc1|casts",{a: a, b: b, c: c, d: d, e: e, f: f});
  return result
}
/**
...
export async function resultArg(a, b, c, d, e, f) {
  const result = await invoke("plugin:8178d1f91285bbc1|result_arg",{a: a, b: b, c: c, d: d, e: e, f: f});
  return result
}
/**
