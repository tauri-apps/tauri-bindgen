...
export async function listU8Param(x) {
  const result = await invoke("plugin:3d9d99368dfa9a39|list_u8_param",{x: x});
  return result
}
/**
* @param {Uint16Array} x
...
export async function listU16Param(x) {
  const result = await invoke("plugin:3d9d99368dfa9a39|list_u16_param",{x: x});
  return result
}
/**
* @param {Uint32Array} x
...
export async function listU32Param(x) {
  const result = await invoke("plugin:3d9d99368dfa9a39|list_u32_param",{x: x});
  return result
}
/**
...
export async function listU64Param(x) {
  const result = await invoke("plugin:3d9d99368dfa9a39|list_u64_param",{x: x});
  return result
}
/**
* @param {Int8Array} x
...
export async function listS8Param(x) {
  const result = await invoke("plugin:3d9d99368dfa9a39|list_s8_param",{x: x});
  return result
}
/**
* @param {Int16Array} x
...
export async function listS16Param(x) {
  const result = await invoke("plugin:3d9d99368dfa9a39|list_s16_param",{x: x});
  return result
}
/**
* @param {Int32Array} x
...
export async function listS32Param(x) {
  const result = await invoke("plugin:3d9d99368dfa9a39|list_s32_param",{x: x});
  return result
}
/**
...
export async function listS64Param(x) {
  const result = await invoke("plugin:3d9d99368dfa9a39|list_s64_param",{x: x});
  return result
}
/**
...
export async function listFloat32Param(x) {
  const result = await invoke("plugin:3d9d99368dfa9a39|list_float32_param",{x: x});
  return result
}
/**
...
export async function listFloat64Param(x) {
  const result = await invoke("plugin:3d9d99368dfa9a39|list_float64_param",{x: x});
  return result
}
/**
...
export async function stringListArg(a) {
  const result = await invoke("plugin:3d9d99368dfa9a39|string_list_arg",{a: a});
  return result
}
/**
...
export async function tupleStringList(x) {
  const result = await invoke("plugin:3d9d99368dfa9a39|tuple_string_list",{x: x});
  return result
}
/**
* @param {string[]} x
...
export async function recordListReverse(x) {
  const result = await invoke("plugin:3d9d99368dfa9a39|record_list_reverse",{x: x});
  return result
}
/**
* @param {SomeVariant[]} x
...
export async function loadStoreEverything(a) {
  const result = await invoke("plugin:3d9d99368dfa9a39|load_store_everything",{a: a});
  return result
}
