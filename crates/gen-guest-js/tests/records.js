...
*/
            export async function tupleArg (x) {
                ...
                return fetch('ipc://localhost/records/tuple_arg', { method: "POST", body: Uint8Array.from(out) })
            }
...
*/
            export async function emptyArg (x) {
                ...
                return fetch('ipc://localhost/records/empty_arg', { method: "POST", body: Uint8Array.from(out) })
            }
...
*/
            export async function scalarArg (x) {
                ...
                return fetch('ipc://localhost/records/scalar_arg', { method: "POST", body: Uint8Array.from(out) })
            }
...
*/
            export async function flagsArg (x) {
                ...
                return fetch('ipc://localhost/records/flags_arg', { method: "POST", body: Uint8Array.from(out) })
            }
...
*/
            export async function aggregateArg (x) {
                ...
                return fetch('ipc://localhost/records/aggregate_arg', { method: "POST", body: Uint8Array.from(out) })
            }
